...
class EvaluationRequest(BaseModel):
    ...
    return_reference_triton: bool = Field(
        default=False,
        description="Capture and return Triton code generated by reference torch.compile in metadata",
    )
    reference_triton_max_chars: int = Field(
        default=120000,
        ge=1000,
        le=1000000,
        description="Maximum characters to return for captured reference Triton code",
    )
